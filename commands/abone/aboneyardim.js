...
exports.run = async(client, message, args) => {
  ...
  .addField(`> ${p}abone-rolü`, "> <:pempe:932898261252079677>", true)
  .addField(`> ${p}abone-admini`, "> <:pempe:932898261252079677>", true)
  .addField(`> ${p}abone-log`, "> <:pempe:932898261252079677>", true)
