...
exports.run = async(client, message, args) => {
 ...
 .setDescription(`
  ...
  .addField(`**> ${p}kayıt-kanal**`, "> <:pempe:932898261252079677>", true)
  .addField(`**> ${p}kayıt-kayıtsız**`, "> <:pempe:932898261252079677>", true)
  .addField(`**> ${p}kayıt-erkek**`, "> <:pempe:932898261252079677>", true)
  .addField(`**> ${p}kayıt-kadın**`, "> <:yesil:933264429179617290>", true)
  .addField(`**> ${p}kayıt-tag**`, "> <:yesil:933264429179617290>", true)
  .addField(`**> ${p}kayıt-kapat**`, "> <:yesil:933264429179617290>", true)
