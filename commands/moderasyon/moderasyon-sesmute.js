...
if(message.author.id === member.id) return message.channel.send(new Discord.MessageEmbed()  .setTitle('Agaa beeeeeeeee!').setDescription(`O kadar yürekli olamazsın.. 🙄`))
...
.setTitle('Ewing - Sesli Mute Sistem')
.setDescription(`
