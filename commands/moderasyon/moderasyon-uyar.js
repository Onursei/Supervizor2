...
if(!args[0]) return message.channel.send(new Discord.MessageEmbed().setColor("00447e").setTitle('> Yanlış Kullanım!').setDescription('**Hatalı Komut Kullanımı Doğru Kullanımı :** \n`e?uyarı ekle` \n`e?uyarı sil` \n`e?uyarı say`'))
