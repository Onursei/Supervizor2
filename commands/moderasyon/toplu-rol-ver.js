    ...
    try {
        switch (option) {
            ...
            case 'ver':
                ...
                break;
            default:
                error(`Lütfen bir opsiyon belirtin.\n\n\`• -toplurol ver <hangiRoldekiÜyelereVerilecek> <verilecekRol>\`\n\`• -toplurol al <hangiRoldekiÜyelerdenAlınacak> <alınacakRol>\``);
        }
    } catch (err) {
...
exports.conf = {
    ...
    description: 'toplu rol',
    
    usage: 'toplu rol al veya al',
